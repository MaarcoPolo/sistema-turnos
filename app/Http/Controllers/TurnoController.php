...
class TurnoController extends Controller
{
    ...
    public function generarReporteTiempoReal(Request $request)
    {
        try {
            ...
            // $prom = "SELECT COUNT(CU) AS total FROM promociones_pen WHERE fecha='$fecha'  and oficialia = '9994'";
            // $dema = "SELECT COUNT(CU) AS total FROM ocomun WHERE fecha='$fecha' AND distrito='PUEBLA'";
            // $apela = "SELECT COUNT(CU) AS total FROM ocomun WHERE fecha='$fecha' AND distrito='APELACION'";
            //fin consultas 209
